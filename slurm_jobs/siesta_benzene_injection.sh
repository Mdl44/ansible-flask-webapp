...
# Type: conda
export PATH="/mnt/nfsshare/miniforge3/bin:$PATH"
source /mnt/nfsshare/miniforge3/etc/profile.d/conda.sh
...
# 4. The application setup injection should add the conda/SIESTA configuration here
# We'll use redirect placeholders that should be replaced
